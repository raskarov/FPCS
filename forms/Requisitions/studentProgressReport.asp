...
<table style="width:100%;" ID="Table3">
	<tr>
		<td class="yellowHeader">
			&nbsp;<b>Progress Report for <% = strStudentName %>, SY <% = oFunc.SchoolYearRange %></b>
		</td>
	</tr>
	<tr>
		<td>
...
sub SendMail(pTo,pSendToGuard,pFrom)	
	...
	cdoConfig.Fields("http://schemas.microsoft.com/cdo/configuration/smtpserver") = "mail.3shapes.com"
