	...
	<tr>
		<td>
			<table ID="Table48" cellspacing="2" >				
				...
				<tr >
					<td rowspan=3 colspan=8 class="svplain8" valign="bottom">	
					<%
...
<%
	...
	sql = "SELECT     ISF.szCourse_Title, POS.txtCourseTitle, ISF.intShort_ILP_ID, I.szName, tblILP.intILP_ID, tblILP.bolApproved AS aStatus,  " & _ 
		...
		"                      CASE ISF.intPOS_Subject_ID WHEN 22 THEN 0 ELSE 1 END AS isSponsor, oi.intQty, oi.curUnit_Price, oi.curShipping, ISF.intCourse_Hrs,  " & _ 
		"                      tblILP.decCourse_Hours, oi.intQty * oi.curUnit_Price + oi.curShipping AS total, oi.intOrdered_Item_ID, tblClasses.intInstructor_ID, tps.szSubject_Name,  " & _ 
