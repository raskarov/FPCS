    ...
    <tr>
        <td bgcolor="f7f7f7" style="width: 100%;">
            ...
            <table cellpadding="3" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td align="center" class="svplain8">
                        ...
                        <input type="text" name="decCourse_Hours" value="<% if (decCourse_Hours = "" or decCourse_Hours = 0)and Session.Contents("intShort_ILP_ID") <> "" then response.Write oFunc.CourseInfo(Session.Contents("intShort_ILP_ID"),"2") else response.Write decCourse_Hours %>"
                            size="4" maxlength="4" onchange="jfChanged();this.form.hdnHrsChanged.value='true';">
                        <% else %>
                        <% = decCourse_Hours%>
                        <% end if %>
                    </td>
            ...
            <table style="width: 100%;" id="Table4">
                ...
                <tr>
                    <td style="width: 100%;" class="svplain8">
                        <% if not bolLock then %>
                        <textarea name="szCurriculum_Desc" onkeydown="jfMaxSize(7000,this);" style='width: 100%;'
                            rows='4' wrap='virtual' onfocus="this.rows=12;" onblur="this.rows=4;" id="Textarea1"><%=szCurriculum_Desc%></textarea>
                        <% else 
            ...
            <table width="100%" id="Table5">
                        ...
                        <table cellpadding="3" cellspacing="0" class="gray" id="Table6">
                            <tr>
                                ...
                                <td><b>Standards: Common core or GLE</b>
                                    <%' <b>Scope and sequence</b><br>(add entire syllabus plan. ex. wk 1 - 8/2/12 to 8/6/12 Coniferous Tree Study)%>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="width: 33%;" valign="top" class="svplain8">
                        <% if not bolLock then %>
                        <textarea name="szTeacher_Role" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=4;"
                            cols="22" rows="3" wrap="virtual" onkeydown="jfMaxSize(7000,this);" id="Textarea4"><%=szTeacher_Role%></textarea>
                        <% else 
                    ...
                    <td valign="top" class="svplain8">
                        <% if not bolLock then %>
                        <textarea name="szRequirements" style="width: 100%;" rows="4" wrap="virtual" onfocus="this.rows=12;"
                            onblur="this.rows=4;" onkeydown="jfMaxSize(7000,this);" id="Textarea3"><%=szRequirements%></textarea>
                        <% else 
                    ...
                    <td class="gray" style="width: 33%;">
                        <table cellpadding="3" cellspacing="0" class="gray" id="Table9">
                            <tr>
                                ...
                                <td>
                                    <b>Role of Parent/Teacher/Vendor/any additional responsibilities of the student</b>
                                </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr><%' Old szTeacher_Role %>
                    <td style="width: 50%;" valign="top" class="svplain8">
                        <% if not bolLock then %>
                        <textarea name="szStudent_Role" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=4;"
                            cols="22" rows="3" wrap="virtual" onkeydown="jfMaxSize(7000,this);" id="Textarea5"><%=szStudent_Role%></textarea>
                        <% else 
                    ...
                    <td style="width: 50%;" valign="top" class="svplain8">
                        <% if not bolLock then %>
                        <textarea name="szParent_Role" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=4;"
                            cols="22" rows="3" wrap="virtual" onkeydown="jfMaxSize(7000,this);" id="Textarea6"><%=szParent_Role%></textarea>
                        <% else 
            ...
            <table width="100%" id="Table10">
                <tr>
                    <td colspan="3">
                        <font class="svplain11"><b><i>Evaluation and Grading</i></b> </font><font class="svplain8">
                            (Please check method(s) that apply)</font>
                    </td>
                </tr>
                <tr>
                    <%
                    ...
                    <td class="gray">
                        &nbsp;<input <% = gradeDisabled %> type="checkbox" name="bolGradingScale" <% if bolGradingScale then response.Write(" checked ")%>
                            id="Checkbox2" value="1">Grading Scale
                    </td>
                    <td class="gray">
                        &nbsp;<input <% = gradeDisabled %> type="checkbox" name="bolOther_Grading" <% if szOther_Grading&"" <> "" then response.Write(" checked ")%>
                            id="Checkbox3" value='1'>Other (if checked you <b>MUST</b> explain why in box
                        #6.)
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="svplain8" valign="top">
                        <b>6. Explain:</b><br>
                        <% if gradeDisabled = "" then %>
                        <textarea rows="7" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=7;"
                            name="szOther_Grading" id="Textarea7"><%=szOther_Grading%></textarea>
                        <% else 
                        ...
                        <table cellpadding="3" cellspacing="0" class="gray" id="Table12">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <b>What will be the measurable outcomes?</b> (Logs are not permissable without measurable
                                    goals included, i.e. run 1.5 hours without stopping, run 4 days per week, or 40
                ...
                <tr>
                    <td valign="top" colspan="3" class="svplain8">
                        <% if not bolLock then %>
                        <textarea name="szEvaluation" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=5;"
                            cols="60" rows="5" wrap="virtual" onkeydown="jfMaxSize(7000,this);"><% = szEvaluation %></textarea>
                        <% else 
                    ...
                    <td class="gray" colspan="3">
                        <table cellpadding="3" cellspacing="0" class="gray" id="Table12">
                            <tr>
                                ...
                                <td>
                                    <b>How often will evaluation marks to be teacher of record? </b>(the end of weeks
                                    4, 8, 12, and 18)<br>
                                </td>
                            </tr>
                        </table>
                            ...
                            <%End If %>
                <tr>
                    <td valign="top" colspan="3" class="gray">
                        <% if False then'not bolLock %>
                        <textarea name="szEvaluationFrequency" style="width: 100%;" onfocus="this.rows=12;"
                            onblur="this.rows=5;" cols="60" rows="5" wrap="virtual" onkeydown="jfMaxSize(500,this);"><% = szEvaluationFrequency %></textarea>
                        <%' else 
						'response.Write szEvaluationFrequency					
					end if %>
                    <b>* FPCS and Correspondence Regulations require at least monthly contact, with at least quarterly reviews of the student's work/progress. *</b>
                    </td>
                </tr>
            </table>
            <% 
            ...
            %>
            <br />
            <table width="100%" id="tblSyllabus">
                <tr>
                    <td class="gray" style="width: 100%;">
                        <table cellpadding="3" cellspacing="0" class="gray" id="Table6">
                            <tr>
                                ...
                                <td><b>Course Syllabus: work out a timeline (scope and sequence) of all major topics to be covered. </b><br />
(add entire syllabus plan. ex. wk 1 - 3 Coniferous Tree Study)
                ...
                <%'If False Then %>
                    ...
                    If re.Test(szGoals) then 
						response.Write "<table class=""svplain10"">" & szGoals	& "</table>"
                    else
                    ...
                    xDoc.LoadXml(szGoals)
                    Dim xLst
                    set xLst = xDoc.selectNodes("//tr[td/@id]")
                    For Each xNode in xLst%>
                            <tr>
                                <td>
                                    <input type="text" name="WeekNo" value='<%=xNode.childNodes(0).Text%>' maxlength="10"
                                        size="2" />
                                </td>
                                <%If False Then %>
                                <td>
                                    <input type="text" class="date" name="dtStart" value='<%=xNode.selectSingleNode("td[@id=""start""]").Text%>'
                                        maxlength="10" size="10" />
                                </td>
                                <td>
                                    <input type="text" class="date" name="dtEnd" value='<%=xNode.selectSingleNode("td[@id=""end""]").Text%>'
                                        maxlength="10" size="10" />
                                </td>
                                <%End If %>
                                <td>
                                    <input type="text" name="szDescription" value='<%=xNode.selectSingleNode("td[@id=""description""]").Text%>' maxlength="200"
                                        size="100" />
                                </td>
                            </tr>
                   <%Next
                    'End If
                            ...
                            <tr>
                                <td>
                                    <input type="hidden" name="syllabusId" value='new' />
                                    <input class="syllabus" type="text" name="WeekNo" value='' maxlength="10" size="2" />
                                </td>
                                <%If False Then %>
                                <td>
                                    <input type="text" class="date syllabus" name="dtStart" value='' maxlength="10" size="10" />
                                </td>
                                <td>
                                    <input type="text" class="date syllabus" name="dtEnd" value='' maxlength="10" size="10" />
                                </td>
                                <%End If %>
                                <td>
                                    <input class="syllabus" type="text" name="szDescription" value='' maxlength="200"
                                        size="100" />
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%" id="Table13">
                <tr>
                    <td class="gray" style="width: 33%;">
                        &nbsp;<b>Guardian ILP Modifications:</b> After an ILP has been signed the signed
                        ILP can not be altered. Please enter additional information in the box below.
                    </td>
                </tr>
                <tr>
                    <td>
                        <textarea name="szILP_Additions" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=4;"
                            cols="22" rows="3" wrap="virtual" onkeydown="jfMaxSize(4000,this);" id="Textarea8"><%=szILP_Additions%></textarea>
                        <% if bolLock then %>
                ...
                <tr>
                    <td class="gray" style="width: 33%;">
                        ...
                        *Please Note* There are currently
                        <% = Enrolled %>
                        student(s) enrolled in this class. Since this ILP has already been accepted in its
                        present form please make any modifications in the box below. These changes will
                        also appear on the students version of the ILP.
                        <% else %>
                        *Please Note* After enrolling your student in this class the instructor made the
                        following modifications to the original ILP ...
                        <% end if %>
                    </td>
                </tr>
                <tr>
                    <td class="svplain8">
                        ...
                        <textarea name="Teacher_Additions" style="width: 100%;" onfocus="this.rows=12;" onblur="this.rows=4;"
                            cols="22" rows="3" wrap="virtual" onkeydown="jfMaxSize(4000,this);" id="Textarea9"><%=Teacher_Additions%></textarea>
            ...
            <table id="Table2">
                <tr>
                    <td colspan="3">
                        <font class="svplain11"><b><i>ILP Bank Information</i></b> </font>
                    </td>
                </tr>
                <tr>
                    <td class="gray">
                    ...
                    <td class="svplain10">
                        <b>Yes</b><input type="checkbox" name="bolILP_Bank" <% if bolILP_Bank = true then response.Write " checked " end if %>
                            id="Checkbox4">
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="svplain10">
                        <input type="text" size="64" maxlength="64" name="szILP_Name" value="<%=szILP_Name%>"
                            id="Text1">
                    </td>
                </tr>
            </table>
...
%>
<input type='<% if bolLock then %>submit<%else%>button<% end if %>' value="SAVE (goods & services page next)"
    class="NavSave" <% if not bolLock then %> onclick="jfValidateForm(this.form);"
    <% end if %>>
<% 
	ELSE
			'existing ILP is being modified
%>
<input type="button" value="Close without saving" onclick="window.opener.focus();window.close();"
    class="NavLink">
    ...
    $(document).ready(function () {
        ...
        function AddRow(elem) {
            ...
            var newTr = tr.parent().append('<tr> \
                    ...
                    <td><input class="syllabus" type="text" name="szDescription" value="" maxlength="200" size="100" /></td> \
                    </tr>');
